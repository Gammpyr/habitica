...
CMD ["sh", "-c", "python manage.py collectstatic --noinput && gunicorn config.wsgi:application --bind 0.0.0.0:8000 && gunicorn --bind 0.0.0.0:8000 --workers 3 --timeout 120 --preload config.wsgi:application"]
